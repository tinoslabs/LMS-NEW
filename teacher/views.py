...
def add_course(request):
    ...
    if not permissions or not permissions.create_Course:
        messages.error(request, " You do not have permission to add a course.")
    ...
    return render(request, 'teacher/course/add_course.html', {'form': form,
        'instructor': instructor,
        'has_create_course': permissions and permissions.create_Course})
