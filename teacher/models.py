...
class Instructor(models.Model): # author in template
    user = models.OneToOneField(Account,on_delete=models.CASCADE,  related_name='teacher_instructors')  
...
class UserCourses(models.Model):
    user = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='teacher_user_courses')
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
...
class QuizAnswer(models.Model):
    user = models.ForeignKey(Account, on_delete=models.CASCADE,related_name='teacher_quiz_answers')  # User who took the quiz
...
class QuizResult(models.Model):
    user = models.ForeignKey(Account, on_delete=models.CASCADE,related_name='teacher_quiz_results')
...
class Certificate(models.Model):
    ...
    uploaded_by = models.ForeignKey(Account,on_delete=models.SET_NULL,null=True,blank=True, related_name='teacher_uploaded_certificates')  # Teacher/Admin who uploaded
    uploaded_at = models.DateTimeField(auto_now_add=True)
